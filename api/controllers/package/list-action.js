    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            if(inputs.filters){
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: Package}); //procesa los filtros secundarios

            }

            filters['packageActive'] = true;
            var records = await Package.count({
                where: filters,
            });
