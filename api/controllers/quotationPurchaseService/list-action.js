module.exports = {
    ...
    friendlyName: 'List',
	description: 'List detail of quotation purchase',
    inputs: 
	{    
        filters: //
        {
    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            filters['quotationPurchaseServiceActive'] = true;
            var records = await QuotationPurchaseService.count({
                where: filters,
            });
            ...
            if(records  > 0  )
            {
                ...
                if(inputs.page <= pages && inputs.page > 0 )
                {
                    ...
                    var list = await QuotationPurchaseService.find({
                        where: filters, 
                        limit: inputs.limit,
                        skip: valueSkip,
