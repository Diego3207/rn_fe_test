module.exports = {
    ...
    friendlyName: 'List ',
	description: 'List purchase order of productos',
    inputs: 
	{    
        filters: //
        {
    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            filters['purchaseOrderProductActive'] = true;
            var records = await PurchaseOrderProduct.count({
                where: filters,
            });
            ...
            if(records  > 0  )
            {
                ...
                if(inputs.page <= pages && inputs.page > 0 )
                {
                    ...
                    var list = await PurchaseOrderProduct.find({
                        where: filters, 
                        limit: inputs.limit,
                        skip: valueSkip,
