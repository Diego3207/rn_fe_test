    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            if(inputs.filters){
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: DataBank}); //procesa los filtros secundarios

            }
            filters['dataBankActive'] = true;


            var records = await DataBank.count({
                where: filters,
            });
