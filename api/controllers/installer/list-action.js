    ...
    fn: async function (inputs, exits) 
	{
		...
		try 
		{
            ...
            if(inputs.filters){
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: Installer}); //procesa los filtros secundarios

                
            }
			
            filters['installerActive'] = true;
            
			var records = await Installer.count
			({
                where: filters,
            });
