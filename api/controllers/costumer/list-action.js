    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            if(inputs.filters){
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: Costumer}); //procesa los filtros secundarios

            }

            filters['costumerActive'] = true;

            var records = await Costumer.count({
                where: filters,
            });
