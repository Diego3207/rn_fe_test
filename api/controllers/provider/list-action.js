    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            if(inputs.filters)
            {
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: Provider}); //procesa los filtros secundarios

            }

            filters['providerActive'] = true;
            var records = await Provider.count({
                where: filters,
            });
