...
module.exports = {
    ...
    friendlyName: 'List ',
	description: 'List  TrackerInstallationAccessory.',
    inputs: 
	{    
        filters: //
        {
    ...
    fn: async function (inputs, exits) 
	{
		...
		try 
		{
            ...
            filters['trackerInstallationAccessoryActive'] = true;
            
			var records = await TrackerInstallationAccessory.count
			({
                where: filters,
            });
            ...
            if(records  > 0  )
            {
                ...
                if(inputs.page <= pages && inputs.page > 0 )
                {
                    ...
                    var list = await TrackerInstallationAccessory.find({
                        where: filters, 
                        limit: inputs.limit,
                        skip: valueSkip,
