    ...
    fn: async function (inputs, exits) 
	{
		...
		{	
            ...
            if(inputs.filters)
			{
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: Module}); //procesa los filtros secundarios

            }
			
            filters['moduleActive'] = true;
            
            var records = await Module.count({
                where: filters,
            });
