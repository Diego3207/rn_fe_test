    ...
    fn: async function (inputs, exits) 
	{
		...
		try 
		{
            ...
            if(inputs.filters){
                ...
                filters = await sails.helpers.processSecondaryFilter.with({filters: filters, mainModel: Service}); //procesa los filtros secundarios

            }
			
            filters['serviceActive'] = true;
            
			var records = await Service.count
			({
                where: filters,
            });
