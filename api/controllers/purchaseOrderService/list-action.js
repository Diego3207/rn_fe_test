module.exports = {
    ...
    friendlyName: 'List',
	description: 'List service of purchase order',
    inputs: 
	{    
        filters: //
        {
    ...
    fn: async function (inputs, exits) 
	{
        try {
            ...
            filters['purchaseOrderServiceActive'] = true;
            var records = await PurchaseOrderService.count({
                where: filters,
            });
            ...
            if(records  > 0  )
            {
                ...
                if(inputs.page <= pages && inputs.page > 0 )
                {
                    ...
                    var list = await PurchaseOrderService.find({
                        where: filters, 
                        limit: inputs.limit,
                        skip: valueSkip,
