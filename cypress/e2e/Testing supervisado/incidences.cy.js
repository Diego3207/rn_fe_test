...
describe("Incidencias",function(){
    ...
    it("Añadir Incidencia válido",function(){
        ...
        cy.get('tbody.ng-tns-c88-58 > :nth-child(2) > :nth-child(4)').click();
        //fecha fin
        cy.get(':nth-child(2) > .p-inputwrapper > .p-calendar > .p-inputtext').click();
        //día 11
        //cy.get('tbody.ng-tns-c88-60 > :nth-child(2) > :nth-child(5) > .p-ripple').click();
        cy.get('tbody.ng-tns-c88-59 > :nth-child(2) > :nth-child(5)').click();
        //descripcion hechos
