...
module.exports = 
{
  ...
  **************************************************************************/
  datastores: {
    ...
    {
		adapter: 'sails-mysql',
		url: 'mysql://rn_admin:cli9OP03t@localhost:3306/rnadmin',
		schema: true,
    },
  ...
  models: {
    ...
    migrate: 'safe',
     ...
     cascadeOnDestroy: false,
	  ...
	  dataEncryptionKeys: {
		default: 'eV8kG436073aEMqyvfk/J4jRnziBd+5BHBT0lHViU3g='
	  },
  ...
  ***************************************************************************/
  sockets: 
  {
    ...
    ***************************************************************************/
     onlyAllowOrigins: [
       'https://adm.reportnow.com.mx',
	   'http://adm.reportnow.com.mx',
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'https://adm.reportnow.com.mx',
